...
Component for displaying and monitoring critical vehicle metrics organized by category.
Provides real-time visualization of key system values from various subsystems with
visual indicators for out-of-range values and includes integrated CAN bus logging functionality.
...
import {
  ...
  BMS_KEYS,
  INVERTER_KEYS
} from '@/infotainment-home/constants/can-keys';
