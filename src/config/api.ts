...
API configuration that centralizes endpoint URLs for vehicle data, CAN statistics,
and logging operations for both development and production environments.
